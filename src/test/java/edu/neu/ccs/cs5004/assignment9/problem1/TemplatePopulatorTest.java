...
public class TemplatePopulatorTest {
  ...
  public void testPopulateAll() throws Exception {
    Method method = tp.getClass().getDeclaredMethod("populateAll", String.class, List.class,
            String.class);
    method.setAccessible(true);
  ...
  public void testMainValidEmail() throws Exception {
    String[] argsValid = {"--email", "--email-template", IO_DIR + "/in/template_email.txt",
            "--output-dir",
  ...
  public void testMainValidLetter() throws Exception {
    String[] argsValid = {"--letter", "--letter-template", IO_DIR + "/in/template_letter.txt",
            "--output-dir", IO_DIR + "/out", "--csv-file", IO_DIR + "/in/theater-company-members" +
            ".csv"};
